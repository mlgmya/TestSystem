...
namespace sy
{
    public partial class Man : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("MStuadd.aspx");
        }
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("delete from MStu where 学号=@id",conn);
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            cmd.CommandText = "update MStu set 学生姓名=@name,班级编号=@class where 学号=@id";
            ...
            cmd.Parameters["@class"].Value = ((TextBox)GridView1.Rows[e.RowIndex].Cells[2].Controls[0]).Text;
